...
exports.SheetsServiceReal = void 0;
...
var SheetsServiceReal = /** @class */ (function () {
    function SheetsServiceReal() {
    }
    SheetsServiceReal.prototype.authClient = function () {
    ...
    SheetsServiceReal.prototype.appendRow = function (spreadsheetId, row) {
        return __awaiter(this, void 0, void 0, function () {
            var client, sheets;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return SheetsServiceReal;
}());
exports.SheetsServiceReal = SheetsServiceReal;
exports.default = new SheetsServiceReal();
