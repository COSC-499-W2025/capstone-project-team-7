            ...
            server.close(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, index_1.defaultQueue.drain(10000)];
                        case 1:
                            _a.sent();
                        ...
                        case 2:
                            err_1 = _a.sent();
                            console.error('Failed to drain queue:', err_1);
                            process.exit(1);
                            return [3 /*break*/, 3];
...
process.on('SIGINT', function () { return shutdown(0); });
process.on('SIGTERM', function () { return shutdown(0); });
