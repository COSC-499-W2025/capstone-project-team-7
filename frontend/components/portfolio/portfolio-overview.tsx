        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.82fr)]">
          <div className="flex gap-4">
            ...
            <div className="min-w-0 space-y-3">
              ...
              <div className="rounded-[16px] border border-primary/25 bg-primary/5 p-3 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className={`inline-flex items-center gap-1.5 rounded-[12px] border px-3.5 py-2 text-xs font-semibold transition-all ${
                        pubSettings?.is_public
                          ...
                          : "border-border bg-card text-foreground hover:bg-muted hover:border-primary/30 shadow-sm"
                    ...
                    {pubSettings?.is_public && pubSettings.share_token && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-[12px] border border-primary/30 bg-primary/10 px-3.5 py-2 text-xs font-semibold text-primary transition-all hover:bg-primary/15 hover:border-primary/50 shadow-sm"
                      >
                        {copied ? (
                          <>
          ...
          <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
            <div className="portfolio-panel-subtle p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="rounded-2xl border border-border bg-card p-2.5 text-foreground shadow-sm">
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex min-w-0 items-start gap-3">
                            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md border border-border bg-card text-sm font-semibold text-foreground">
                              #{index + 1}
                            </div>
                            <div className="min-w-0">
                              <div className="flex flex-wrap items-center gap-2">
                        ...
                        <div className="mt-4 flex items-start justify-between gap-3">
                          ...
                          <Link
                            ...
                            className="inline-flex flex-shrink-0 items-center gap-1 text-xs font-semibold text-foreground transition-colors hover:text-foreground"
                          >
                            View details
